...
public class User {
	...
	public String toString() {
		return "User [id=" + id + ", name=" + name + ", email=" + email + ", password=" + password + ", phno=" + phno
				...
				+ ", pincode=" + pincode + ", getId()=" + getId() + ", getName()=" + getName() + ", getEmail()="
				+ getEmail() + ", getPassword()=" + getPassword() + ", getPhno()=" + getPhno() + ", getAddress()="
				+ getAddress() + ", getLandmark()=" + getLandmark() + ", getCity()=" + getCity() + ", getState()="
